...
function D.LOAD.R:LoadTargetFrame()
	...
	local F = Button('ConceptionUI TargetFrame', C, 'BOTTOMLEFT', UIParent, 'CENTER', cfg.x, cfg.y, cfg.hpBarW, cfg.hpBarH+cfg.ppBarH+cfg.fontSize+6, 'SecureUnitButtonTemplate')
